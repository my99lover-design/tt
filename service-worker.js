const CACHE_NAME = "gimpo-b-pwa-v2";
const APP_SHELL = ["./", "./index.html", "./style.css", "./script.js", "./locations.json", "./manifest.json", "./icons/icon-180.png", "./icons/icon-192.png", "./icons/icon-512.png"];
