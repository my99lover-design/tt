const CACHE_NAME = "gimpo-b-pwa-v7";
const APP_SHELL = ["./", "./index.html", "./style.css?v=5", "./script.js?v=7", "./locations.json", "./manifest.json", "./icons/icon-180.png", "./icons/icon-192.png", "./icons/icon-512.png"];
